...
public interface IShape {
   ...
   * @throws IllegalArgumentException if the new width is less than or equal to zero.
   *                                  if the shape is of type circle or square.
   */
   ...
   * @throws IllegalArgumentException if the new height is less than or equal to zero.
   *                                  if the shape is of type circle or square.
   */
   ...
   * @throws IllegalArgumentException if the new radius is less than or equal to zero.
   *                                  if the shape is not of type circle.
   */
   ...
   *                                  if the shape is not of type square.
   */
